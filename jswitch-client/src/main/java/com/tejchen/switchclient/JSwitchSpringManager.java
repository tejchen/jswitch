...
public class JSwitchSpringManager implements ApplicationContextAware {
    ...
    public void init(){
        ...
        Map<String, Object> target = context.getBeansWithAnnotation(SpringJSwitch.class);
        ...
        Class[] classList = target.values().stream()
                .filter(x->{
                    ...
                    SpringJSwitch springJSwitch = (SpringJSwitch) xClass.getAnnotation(SpringJSwitch.class);
                    return springJSwitch.namespace().equals(namespace);
